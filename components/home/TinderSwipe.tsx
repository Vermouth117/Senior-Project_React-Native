...
const TinderSwipe: React.FC<Props> = memo(
  ({ index, card, setPage, setIndex, scheduleNotificationAsync }) => {
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            <Swiper
              ...
              nextButton={
                <Text style={{ color: "rgba(255,255,255,0.9)", fontSize: 50 }}>
                  ›
                </Text>
              }
              prevButton={
                ...
                <View style={styles.cardTextTokimekiContainer}>
                  <Text style={styles.cardTextAddressTitle}>
                    <Icon
                      ...
                      style={styles.cardTextAddressTitle}
                    />
                    所在地
                  </Text>
                  <Text
                  ...
                  <Text style={styles.cardTextTokimeki}>
                    大人も子供も楽しめる、駅近、駐車場無料、映えスポット、カップルにおすすめ、ペットOK、〇〇近く、食べ歩き、コスパ最高、贅沢、記念日デート、〇〇が人気、テレビに登場
                  </Text>
                </View>
              </View>
            </TouchableWithoutFeedback>
